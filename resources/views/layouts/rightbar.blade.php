                ...
                <div class="col-md-12 align-self-center">
                    <div class="togglebar">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <div class="logobar">
                                    <a href="{{url('/')}}" class="logo logo-large"><img src="{{asset('assets/images/logotopbar.png')}}" class="img-fluid" alt="logo"></a>
                                </div>
                            </li>
                            <li class="list-inline-item">
                                <div class="searchbar">
                    ...
                    <div class="infobar">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                ...
                                @else
                                    <div class="profilebar">
                                        <h6><a href="{{route('login')}}">Iniciar sesión</a> / <a href="{{route('register')}}">Registrarse</a> </h6>
                                    </div>
                                @endif
                            </li>
