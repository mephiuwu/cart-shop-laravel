            ...
            <div class="infobar-settings-sidebar-body">
                <div class="custom-mode-setting">
                    ...
                    <div class="row align-items-center pb-3">
                        ...
                        <div class="col-4 text-right"><input type="checkbox" class="js-switch-setting-seventh"
                                checked /></div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right"><input type="checkbox" class="js-switch-setting-eightth"
                                checked /></div>
                    </div>
                </div>
            </div>
